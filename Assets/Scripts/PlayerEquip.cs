...
public class PlayerEquip : MonoBehaviour {
	...
	public ItemWeapon WeaponChange(int number) {
		...
		case (int)itemWeaponList.Player_Weapon_Pistol_1:
			return new ItemWeapon (2,	"Pistol_1",		weaponModel[2], 	1, 		4f * weaponDamageAdd[2]		,	1f,		1.5f, 	Mathf.RoundToInt(80f * weaponClipAdd[2])	,	10f,	0.25f,	1f, 	6f / 60f,	ItemWeapon.weaponShellList.ShellPistol,	true,	weaponLaserAdd[2]	,	new Vector3 (0f, -0.25f, 0f), 	new Vector3 (0f, 0.02f, 0.23f));
		case (int)itemWeaponList.player_Weapon_SMG_1:
			return new ItemWeapon (3,	"SMG_1",		weaponModel[3], 	1, 		5f * weaponDamageAdd[3]		,	1.5f,	0.5f,	Mathf.RoundToInt(250f * weaponClipAdd[3])	,	10f,	0.25f,	2f, 	7f / 60f,	ItemWeapon.weaponShellList.ShellPistol,	false,	weaponLaserAdd[3]	,	new Vector3 (0f, -0.45f, 0f),	new Vector3 (0f, 0.0875f, 0.75f));
		case (int)itemWeaponList.Player_Weapon_SMG_2:
			return new ItemWeapon (4,	"SMG_2",		weaponModel[4],		1, 		4f * weaponDamageAdd[4]		,	1f,		0.75f, 	Mathf.RoundToInt(300f * weaponClipAdd[4])	,	10f,	0.1f,	1.5f,	4f / 60f,	ItemWeapon.weaponShellList.ShellPistol,	false,	weaponLaserAdd[4]	,	new Vector3 (0f, -0.375f, 0f),	new Vector3 (0f, 0.03f, 0.92f));
		...
		case (int)itemWeaponList.Player_Weapon_SMG_3:
			return new ItemWeapon (6,	"SMG_3",		weaponModel[6],		1, 		3.5f * weaponDamageAdd[6]	,	1f,		0.75f, 	Mathf.RoundToInt(400f * weaponClipAdd[6])	,	10f,	0.25f,	2.5f,	3f / 60f,	ItemWeapon.weaponShellList.ShellPistol,	false,	weaponLaserAdd[6]	,	new Vector3 (0f, -0.45f, 0f),	new Vector3 (0f, -0.015f, 0.6f));
		}
		return null;
